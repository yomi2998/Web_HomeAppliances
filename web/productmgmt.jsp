                            ...
                            <div class="container" style="display: none;">
                                ...
                                <div id="product-tab">
                                    ...
                                    <table class="nelson-table-ii">
                                        ...
                                        <tr>
                                            <td><img src="<%= product.getDisplay_image_url() %>" alt="<%= product.getName() %>" style="height: 100px;"></td>
                                ...
                                <div id="add-product-tab" hidden>
                                    <form method="post" id="addProductForm">
                                        <div class="input-field">
                                            <label for="name" class="label-with-margin">Name:</label><br>
                                            <input autocomplete="off" type="text" name="name" placeholder="Name" class="nelson-input" required><br>
                                            <p id="invalid-name" class="hidden" style="color:red;">Invalid name.</p>
                                        </div>
                                        <div class="input-field">
                                            ...
                                            <p id="invalid-price" class="hidden" style="color:red;">Invalid price.</p>
                                        </div>
                                        <div class="input-field">
                                            ...
                                            <p id="invalid-stock" class="hidden" style="color:red;">Invalid stock.</p>
                                        </div>
                                        <div class="input-field">
                                            ...
                                            <p id="invalid-description" class="hidden" style="color:red;">Invalid description.</p>
                                        </div>
                                        <div class="input-field">
                                            <label for="category" class="label-with-margin">Category:</label><br>
                                            <div>
                                            <select name="category" class="nelson-select" id="option-category" required>
                                        ...
                                        <div class="input-field">
                                            <label for="image" class="label-with-margin">Images:</label><br>
                                            <input id="add-product-images" autocomplete="off" type="file" name="image" class="nelson-input" accept="image/png, image/jpg, image/jpeg, image/webp" required multiple><br>
                                            <p id="invalid-image" class="hidden" style="color:red;">Invalid image.</p>
                                        ...
                                        <div class="input-field">
                                            ...
                                            <p id="invalid-display_image" class="hidden" style="color:red;">Invalid display image.</p>
                                        </div>
                                        <hr>
                                        <div class="buttons-field">
                                            <button class="nelson-button" type="reset">Cancel</button>
